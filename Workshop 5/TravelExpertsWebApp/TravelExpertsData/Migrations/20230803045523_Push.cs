        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustUsername = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    CustPassword = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    CustConfirmPassword = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Packages__53E8ED9946414817", x => x.PackageProductSupplierId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Packages__29CA8E958A70DA4C",
                table: "Packages_Products_Suppliers",
